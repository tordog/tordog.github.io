...
<head>
	...
	<title>
		...
		if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'lugada' ), max( $paged, $page ) );?>
	</title> 
	...
	<link rel="shortcut icon" href="http://localhost/float/wp-content/uploads/2014/04/imgres.jpg">
...
<body <?php body_class('lugada'); ?> itemscope itemtype="http://schema.org/WebPage">
	...
	<div class="container headerarea">
		<div class="row ">
			<div class="column-half ">
				<header>
					<div class = "TorieNielsen"> TORIE </div>
