...
== Usage manual ==
1. Social option (Appearance > Lugada Options > Social Option) : fill twitter with your twitter username without '@' , facebook page url.
2. Slide option (Appearance > Lugada Options > Slide Option) : fill [Image Source URL] with image URL to show slider.
...
5. Lugada default logo is image logo, you can change image logo in (Appearance > Header) then upload image with your desired image logo. You can also use text logo, just click [Remove Header Image] button.
